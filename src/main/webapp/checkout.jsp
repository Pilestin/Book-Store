                        ...
                        <div class="card-body">
                            ...
                            <form action="#!">
                                ...
                                <div class="container text-center">
                                    ...
                                    <a href="basarili.jsp"><button class="btn btn-outline-primary">Sipariş Ver</button></a> 
                                    <a href="basarili.jsp"><button class="btn btn-outline-primary">Alışverişe Devam Et</button></a> 
                                </div>
